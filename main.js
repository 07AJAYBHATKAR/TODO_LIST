...
// let data = await fetch('https://mayur-85674-default-rtdb.firebaseio.com/task.json');
/**
...
async function addTask(event) {
  ...
  try {
    const response = await fetch('https://group--11-default-rtdb.firebaseio.com//task.json',
      {
        method: "POST",
